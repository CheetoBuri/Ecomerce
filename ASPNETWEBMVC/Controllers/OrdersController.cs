...
namespace ASPNETWEBMVC.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderID,OrderDate,AgentID,TotalAmount")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderID,OrderDate,AgentID,TotalAmount")] Order order)
        {
            if (ModelState.IsValid)
            {
